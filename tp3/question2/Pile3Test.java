 ...
 *          ensemble de conditions qui sont vraies pour chaque méthode Test � 
 ...
 *          engagements, et suivi d'un appel �  tearDown(), qui les détruit.
 */
public class Pile3Test extends junit.framework.TestCase {
	// Définissez ici les variables d'instance nécessaires �  vos engagements;
	// Vous pouvez également les saisir automatiquement du présentoir
	// �  l'aide du menu contextuel "Présentoir --> Engagements".
	...
	/**
	 * Il ne vous reste plus qu'�  définir une ou plusieurs méthodes de test. Ces
	 * méthodes doivent vérifier les résultats attendus �  l'aide d'assertions
